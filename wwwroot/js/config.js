...
const i18n = {
    zh: {
        ...
        th_display_name: "顯示名稱", th_level: "層級", th_status: "狀態", th_open_pref: "開啟方式偏好", th_actions: "操作", th_type: "類型", th_open_config: "開啟配置 / 路徑", th_content_config: "內容配置 (子選單 / 網址)", th_fab_id: "廠區(ID)", th_default_lang: "預設語言", th_applied_roles: "套用的權限群組", th_role_name: "群組名稱", th_allowed_menus: "允許的選單組合", th_emp_id: "工號", th_name_dept: "姓名/部門", th_role_level: "權限層級", th_default_home: "登入預設首頁", th_visible_roles: "可視群組版面", th_apply_time: "申請時間", th_apply_type: "申請類別 / 廠區", th_apply_reason: "申請原因與需求細節", th_apply_status: "處理狀態", th_apply_progress: "處理進度與回覆", th_applicant: "申請人",
