...
const i18n = {
    zh: {
        ...
        wp_edit: "看板網頁內容配置", wp_type: "看板類型", wp_link: "網頁連結", wp_grid: "應用集合", sys_name: "系統名稱", icon: "圖示 (Icon)", open_target: "開啟方式", iframe: "嵌入網頁 (Iframe)", blank: "新分頁 (Blank)", blank_ie: "另開分頁 (IE)", fullscreen: "全螢幕",
