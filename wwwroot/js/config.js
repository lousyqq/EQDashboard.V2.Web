...
const i18n = {
    zh: {
        ...
        th_display_name: "顯示名稱", th_level: "層級", th_status: "狀態", th_open_pref: "開啟方式偏好", th_actions: "操作", th_type: "類型", th_open_config: "開啟配置 / 路徑", th_content_config: "內容配置 (子選單 / 網址)", th_fab_id: "廠區(ID)", th_default_lang: "預設語言", th_applied_roles: "套用的權限群組", th_role_name: "群組名稱", th_allowed_menus: "允許的看板組合", th_emp_id: "工號", th_name_dept: "姓名/部門", th_role_level: "權限層級", th_default_home: "登入預設首頁", th_visible_roles: "可視群組版面", th_apply_time: "申請時間", th_apply_type: "申請類別 / 廠區", th_apply_reason: "申請原因與需求細節", th_apply_status: "處理狀態", th_apply_progress: "處理進度與回覆", th_applicant: "申請人",
        modal_btn_cancel: "取消", modal_btn_save: "儲存",
        fab_edit: "廠區編輯", fab_id: "廠區 ID", role_edit: "群組編輯", acc_edit: "帳號設定", name: "姓名", dept: "部門", role_level: "管理層級", delegation: "啟用委派管理", can_edit_others: "允許變更他人內容", manage_menu: "管理目錄", visible_boards: "可視群組版面",
        wp_edit: "看板網頁內容配置", wp_type: "看板類型", wp_link: "網頁連結", wp_grid: "應用集合", sys_name: "系統名稱", icon: "圖示 (Icon)", open_target: "開啟方式", iframe: "嵌入網頁 (Iframe)", blank: "新分頁 (Blank)", fullscreen: "全螢幕",
    ...
    en: {
        ...
        th_display_name: "Display Name", th_level: "Level", th_status: "Status", th_open_pref: "Open Preference", th_actions: "Actions", th_type: "Type", th_open_config: "Open Config / Path", th_content_config: "Content Config", th_fab_id: "Fab (ID)", th_default_lang: "Default Lang", th_applied_roles: "Applied Roles", th_role_name: "Role Name", th_allowed_menus: "Allowed Menus", th_emp_id: "Emp ID", th_name_dept: "Name/Dept", th_role_level: "Role Level", th_default_home: "Default Home", th_visible_roles: "Visible Roles", th_apply_time: "Request Time", th_apply_type: "Type / Fab", th_apply_reason: "Reason & Details", th_apply_status: "Status", th_apply_progress: "Progress & Reply", th_applicant: "Applicant",
        modal_btn_cancel: "Cancel", modal_btn_save: "Save",
        fab_edit: "Edit Fab", fab_id: "Fab ID", role_edit: "Edit Role", acc_edit: "Account Setup", name: "Name", dept: "Dept", role_level: "Role Level", delegation: "Enable Delegation", can_edit_others: "Can Edit Others", manage_menu: "Manage Menu", visible_boards: "Visible Boards",
        wp_edit: "Webpage Config", wp_type: "Type", wp_link: "Link", wp_grid: "App Grid", sys_name: "Sys Name", icon: "Icon", open_target: "Open Target", iframe: "Iframe", blank: "New Tab", fullscreen: "Fullscreen",
    ...
    ja: {
        ...
        th_display_name: "表示名", th_level: "レベル", th_status: "ステータス", th_open_pref: "開く設定", th_actions: "操作", th_type: "タイプ", th_open_config: "開く構成 / パス", th_content_config: "コンテンツ構成", th_fab_id: "工場(ID)", th_default_lang: "デフォルト言語", th_applied_roles: "適用された権限", th_role_name: "グループ名", th_allowed_menus: "許可されたメニュー", th_emp_id: "社員番号", th_name_dept: "氏名/部署", th_role_level: "権限レベル", th_default_home: "デフォルトホーム", th_visible_roles: "表示グループ", th_apply_time: "申請時間", th_apply_type: "申請タイプ / 工場", th_apply_reason: "申請理由と詳細", th_apply_status: "ステータス", th_apply_progress: "進捗と返信", th_applicant: "申請者",
        modal_btn_cancel: "キャンセル", modal_btn_save: "保存",
        fab_edit: "工場編集", fab_id: "工場 ID", role_edit: "グループ編集", acc_edit: "アカウント設定", name: "氏名", dept: "部署", role_level: "管理レベル", delegation: "委任管理を有効にする", can_edit_others: "他人のコンテンツ変更を許可", manage_menu: "管理ディレクトリ", visible_boards: "表示可能なグループ",
        wp_edit: "Webページ設定", wp_type: "タイプ", wp_link: "リンク", wp_grid: "アプリグリッド", sys_name: "システム名", icon: "アイコン", open_target: "開く方法", iframe: "Iframe", blank: "新しいタブ", fullscreen: "フルスクリーン",
...
function t(key, fallback) {
    if (typeof i18n !== 'undefined' && i18n[currentLang] && i18n[currentLang][key] !== undefined && i18n[currentLang][key] !== null) return i18n[currentLang][key];
