...
import { getCustomMenus, getRoles } from '../config.js?v=20260719c';


import { hideModalSafely, showModalSafely } from './modal-utils.js?v=20260719c';
import { deleteRoleAPI, fetchInitialDataFromDB, saveRoleAPI } from '../api.js?v=20260719c';
import { renderSidebarMenus } from '../render/sidebar.js?v=20260719c';
import { renderAccountTable, renderFabTable, renderRoleTable } from '../render/tables.js?v=20260719c';
